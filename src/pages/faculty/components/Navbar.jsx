        ...
        <>
            <nav className="fixed top-0 left-0 w-full bg-[#faf6f3] shadow-md px-4 sm:px-6 py-3 flex items-center justify-between font-medium z-50">
                ...
                <div className="hidden lg:flex space-x-4 text-gray-700 absolute left-1/2 transform -translate-x-1/2">
                    <Link to="/faculty/completed" className="hover:text-[#a30c34] transition-colors duration-200 px-3 py-2 rounded-md hover:bg-gray-100 text-sm">
                        Completed
                    </Link>
                    <Link to="/faculty/dashboard">
                        <p>Dashboard</p>
                    </Link>
                    <Link to="/faculty/incompleted" className="hover:text-[#a30c34] transition-colors duration-200 px-3 py-2 rounded-md hover:bg-gray-100 text-sm">
                        Incompleted
                    </Link>
                </div>
                ...
                <div className="flex items-center space-x-2 sm:space-x-4 relative">
                    ...
                    <div className="hidden lg:block relative" ref={dropdownRef}>
                        ...
                        >
                            ...
                            <span className="hidden sm:block text-gray-700 group-hover:text-[#a30c34] text-sm">Sankalp Sir</span>
                        </button>
                            ...
                            <div className="absolute right-0 mt-2 w-40 sm:w-48 bg-white border border-gray-200 shadow-xl rounded-xl z-50 overflow-hidden">
                                <div className="p-3 border-b border-gray-100">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <p className="font-semibold text-gray-800 text-sm">Sankalp M tellur</p>
                    ...
                    <div className="mobile-menu absolute top-0 right-0 w-80 h-full bg-white shadow-2xl transform transition-transform duration-300 ease-in-out">
                        ...
                        <div className="p-6 border-b border-gray-200">
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    <h4 className="font-semibold text-gray-800 text-lg">Sankalp M Tellur</h4>
                                    <p className="text-sm text-gray-500">Faculty</p>
                                    <p className="text-xs text-gray-400">2401010383</p>
                                </div>
                            </div>
                        </div>
