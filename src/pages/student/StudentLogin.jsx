    ...
    return (
        <div className="min-h-screen flex flex-col bg-[#faf6f3] font-['Playfair_Display']">
            ...
            <main className="flex flex-col items-center justify-center flex-1 text-center px-4">
                ...
                <button
                    type="button"
                    className="w-full max-w-sm bg-white border border-gray-300 text-gray-700 font-medium py-3 px-4 rounded-lg hover:bg-gray-50 transition flex items-center justify-center space-x-3 text-lg"
                >
